...
public:
     ...
     * @param mat_id - material ID
     */
    Hexahedron(int v1, int v2, int v3, int v4, int v5, int v6, int v7, int v8, int mat_id = 0);
};
...
public:
     ...
     * @param mesh - reference to mesh generated by Femocs
     */
...
private:
     ...
     */
    void edge_numeration(std::vector<MeshElement*> &cells, const IncidenceMatrix &incidence_matrix,
     ...
     */
    void face_numeration(std::vector<MeshElement*> &cells, const IncidenceMatrix &incidence_matrix,
     ...
     */
    int find_face_from_two_edges(int edge1, int edge2, const IncidenceMatrix &vertices_incidence,
     ...
     */
    void convert_tetrahedra(int n_old_vertices, const IncidenceMatrix &incidence_matrix,
     ...
     */
    void convert_triangles(const IncidenceMatrix &incidence_matrix, int n_old_vertices,
            bool numerate_edges, const VectorMap &edge_vertex_incidence = VectorMap());
     ...
     * @param n_old_vertices - the number of original mesh vertices
     */
    void redefine_lines(const IncidenceMatrix &incidence_matrix, int n_old_vertices);
