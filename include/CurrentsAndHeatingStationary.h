 ...
 */
//template<int dim>
//class CurrentHeatStatSolver : public DealSolver<dim> {
//public:
//
//    /**
...
//     */
//    CurrentHeatStatSolver(PhysicalQuantities *pq_, Laplace<dim> *laplace_);
//
//    /**
...
//     * The mesh must be imported again (corresponding to the new laplace object)
//     */
//    void reinitialize(Laplace<dim> *laplace_, CurrentHeatStatSolver *ch_previous_iteration_);
//
...
//    CurrentHeatStatSolver* previous_iteration;
