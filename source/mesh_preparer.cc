...
template <int dim>
void MeshPreparer<dim>::mark_boundary(Triangulation<dim> *triangulation, char top, char bottom, char sides, char other) {
...
template <int dim>
Triangulation<dim> MeshPreparer<dim>::remove_cells_with_id(Triangulation<dim> *triangulation, int id) {
