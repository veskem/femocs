...
//template<int dim>
//CurrentHeatStatSolver<dim>::CurrentHeatStatSolver() : DealSolver<dim>(),
...
//
//template<int dim>
//CurrentHeatStatSolver<dim>::CurrentHeatStatSolver(PhysicalQuantities *pq_, Laplace<dim>* laplace_) :
//        DealSolver<dim>(),
//        ambient_temperature(ambient_temperature_default),
//        fe(FE_Q<dim>(this->shape_degree), 1, // Finite element type (1) = linear, etc and number of components
//           FE_Q<dim>(this->shape_degree), 1), // (we have 2 variables: potential and T with 1 component each)
...
//template<int dim>
//CurrentHeatStatSolver<dim>::CurrentHeatStatSolver(PhysicalQuantities *pq_, Laplace<dim>* laplace_,
//        CurrentHeatStatSolver *ch_previous_iteration_) :
//        ambient_temperature(ambient_temperature_default),
//        fe(FE_Q<dim>(this->shape_degree), 1, // Finite element type (1) = linear, etc and number of components
//           FE_Q<dim>(this->shape_degree), 1), // (we have 2 variables: potential and T with 1 component each)
...
//
//template<int dim>
//void CurrentHeatStatSolver<dim>::reinitialize(Laplace<dim>* laplace_) {
...
//
//template<int dim>
//void CurrentHeatStatSolver<dim>::set_physical_quantities(PhysicalQuantities *pq_) {
//    pq = pq_;
//}
//
//template<int dim>
//void CurrentHeatStatSolver<dim>::set_ambient_temperature(double ambient_temperature_) {
//    ambient_temperature = ambient_temperature_;
//}
//
//template<int dim>
//Vector<double>* CurrentHeatStatSolver<dim>::get_solution() {
//    return &present_solution;
//}
//
//template<int dim>
//void CurrentHeatStatSolver<dim>::mark_boundary() {
...
//
//template<int dim>
//vector<double> CurrentHeatStatSolver<dim>::get_temperature(const vector<int> &cell_indexes,
...
//
//template<int dim>
//vector<Tensor<1, dim> > CurrentHeatStatSolver<dim>::get_current(
...
//
//template<int dim>
//void CurrentHeatStatSolver<dim>::setup_system() {
...
//
//template<int dim>
//bool CurrentHeatStatSolver<dim>::setup_mapping() {
//
//    double eps = 1e-9;
//
//    // ---------------------------------------------------------------------------------------------
...
//
//template<int dim>
//bool CurrentHeatStatSolver<dim>::setup_mapping_field(double smoothing) {
//
//    double eps = 1e-9;
//
//    // ---------------------------------------------------------------------------------------------
...
//
//template<int dim>
//void CurrentHeatStatSolver<dim>::get_surface_nodes(vector<Point<dim>>& nodes) {
...
//
//template<int dim>
//void CurrentHeatStatSolver<dim>::set_electric_field_bc(const vector<double>& elfields) {
...
//
//template<int dim>
//void CurrentHeatStatSolver<dim>::set_initial_condition_slow() {
...
//
//template<int dim>
//void CurrentHeatStatSolver<dim>::set_initial_condition() {
//
...
//template<int dim>
//void CurrentHeatStatSolver<dim>::assemble_system_newton() {
//
...
//
//template<int dim>
//void CurrentHeatStatSolver<dim>::solve() {
...
//
//template<int dim>
//void CurrentHeatStatSolver<dim>::run() {
//
//    cout << "/---------------------------------------------------------------/" << endl
...
//
//template<int dim>
//double CurrentHeatStatSolver<dim>::run_specific(double temperature_tolerance, int max_newton_iter,
...
//
//template<int dim>
//void CurrentHeatStatSolver<dim>::output_results(const string file_name,
...
//template class CurrentHeatStatSolver<2> ;
//template class CurrentHeatStatSolver<3> ;
