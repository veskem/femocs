...
public:
    ...
    ;
    const shared_ptr<Mesh> get_union_mesh(shared_ptr<Mesh> mesh_bulk, shared_ptr<Mesh> mesh_volume, const Femocs::SimuCell* cell, const string cmd);
    ...
    void mark_faces(shared_ptr<Mesh> mesh, const Femocs::SimuCell* cell);
...
private:
    ...
    bool on_surface(const double f1n1, const double f1n2, const double f1n3, const double zmin);
